/* 
 * set_iterate3.c - test program for simple set module, added set intersection 
 *
 * David Kotz - April 2016, updated May 2016, 2017
 * updated by Xia Zhou - 2017, 2019
...
int main() 
{
  ...
  printf("\nIntersect result and setB: \n");
  set_intersect(result, setB);
  set_print(result, stdout, itemprint);
  putchar('\n'); 
